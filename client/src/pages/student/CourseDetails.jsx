...
const CourseDetails = () => {
  ...
  return courseData ?  (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 left-0 w-full h-96 -z-1 bg-linear-to-b from-cyan-100/70'></div>

      {/* left Column */}
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-3xl text-4xl  font-semibold text-gray-800'>{courseData.courseTitle}</h1>
      ...
      {/* right Column */}
      <div className='max-w-[400px] z-10 shadow-2xl  rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        {
             playerData ? 
        ...
        <div className='p-5'>
          ...
          <div className='flex gap-3 items-center pt-2'>
            ...
            <p className='md:textt-lg text-gray-500'>{courseData.discount}% off</p>
          </div>
